...
//    $mail->SMTPDebug  = 2;                     // enables SMTP debug information (for testing)
    ...
    $mail->SMTPAuth   = true;                  // enable SMTP authentication
    $mail->CharSet = 'UTF-8';
    $mail->SMTPSecure = $settings['mail']['system']['SMTPSecure'];               // sets the prefix to the servier
    $mail->Host       = $settings['mail']['system']['host'];      // sets GMAIL as the SMTP server
    $mail->Port       = $settings['mail']['system']['port'];                   // set the SMTP port for the GMAIL server
    $mail->Username   = $username;  // GMAIL username
    $mail->Password   = $password;            // GMAIL password
