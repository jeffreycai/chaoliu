...
<div class='form-group'>
  <label class='col-sm-2 control-label'>负责职员 <span style="color: rgb(185,2,0); font-weight: bold;">*</span></label>
  <div class='col-sm-10'>
...
<div class='form-group'>
  <label class='col-sm-2 control-label' for='name'>姓名 <span style="color: rgb(185,2,0); font-weight: bold;">*</span></label>
  <div class='col-sm-10'>
...
<div class='form-group'>
  <label class='col-sm-2 control-label' for='chushengriqi'>出生日期 </label>
  <div class='col-sm-10'>
...
<div class='form-group'>
  <label class='col-sm-2 control-label'>雅思成绩 </label>
  <div class='col-sm-10'>
...
<div class='form-group'>
  <label class='col-sm-2 control-label' for='dianhua'>电话 <span style="color: rgb(185,2,0); font-weight: bold;">*</span></label>
  <div class='col-sm-10'>
...
<div class='form-group'>
  <label class='col-sm-2 control-label' for='dizhi'>地址 <span style="color: rgb(185,2,0); font-weight: bold;">*</span></label>
  <div class='col-sm-10'>
